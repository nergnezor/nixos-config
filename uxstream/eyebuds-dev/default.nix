...
{ lib, stdenv, makeWrapper, python3, ffmpeg, v4l-utils, android-tools }:
let
...
stdenv.mkDerivation {
  ...
  installPhase = ''
    ...
    wrapProgram $out/bin/eyebuds-dev --prefix PATH : ${lib.makeBinPath [ ffmpeg v4l-utils android-tools ]}
